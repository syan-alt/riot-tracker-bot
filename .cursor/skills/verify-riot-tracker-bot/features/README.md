...
- A real Riot ID via `VERIFY_RIOT_ID`, `PRODUCTION_DB_PATH`, or `RAILWAY_TOKEN` (see the skill Launch section).
...
- Report unreachable features with the missing prerequisite (e.g. no `RAILWAY_TOKEN`).
